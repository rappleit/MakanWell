    ...
    return (
        <SafeAreaView style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center', marginHorizontal: 20 }}>
            ...
            <View style={styles.fields}>
                ...
                <TouchableOpacity onPress={handleSignUp} style={styles.loginButton}><Text style={styles.buttonLabel}>Sign Up</Text></TouchableOpacity>
                <TouchableOpacity onPress={() => navigation.navigate('Login')}><Text style={{ fontSize: 16, textAlign: "center", marginTop: 12, color: COLORS.primary }}>Already have an account? Login here!</Text></TouchableOpacity>
